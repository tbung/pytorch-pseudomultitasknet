...
from FrEIA import rev_multiplicative_layer, F_conv
...
class PseudoMultiTaskNet(nn.Module):
    def __init__(self, no_svd=False, small=False):
...
class PseudoMultiTaskNetMult(nn.Module):
    def __init__(self, no_svd=False):
        ...
        self.revblock2 = rev_multiplicative_layer(((4,),), F_class=F_conv)
        self.revblock21 = rev_multiplicative_layer(((4,),), F_class=F_conv)
        self.revblock22 = rev_multiplicative_layer(((4,),), F_class=F_conv)

        self.revblock3 = rev_multiplicative_layer(((16,),), F_class=F_conv)
        self.revblock31 = rev_multiplicative_layer(((16,),), F_class=F_conv)
        self.revblock32 = rev_multiplicative_layer(((16,),), F_class=F_conv)

        self.revblock4 = rev_multiplicative_layer(((64,),), F_class=F_conv)
        self.revblock41 = rev_multiplicative_layer(((64,),), F_class=F_conv)
        self.revblock42 = rev_multiplicative_layer(((64,),), F_class=F_conv)

        self.revblock5 = rev_multiplicative_layer(((256,),), F_class=F_conv)
        self.revblock51 = rev_multiplicative_layer(((256,),), F_class=F_conv)
        self.revblock52 = rev_multiplicative_layer(((256,),), F_class=F_conv)
    ...
    def generate(self, y):
        x = self.revblock52(y, rev=True)
        x = self.revblock51(x, rev=True)
        x = self.revblock5(x, rev=True)
        x = unsqueeze(x)
        x = self.revblock42(x, rev=True)
        x = self.revblock41(x, rev=True)
        x = self.revblock4(x, rev=True)
        x = unsqueeze(x)
        x = self.revblock32(x, rev=True)
        x = self.revblock31(x, rev=True)
        x = self.revblock3(x, rev=True)
        x = unsqueeze(x)
        x = self.revblock22(x, rev=True)
        x = self.revblock21(x, rev=True)
        x = self.revblock2(x, rev=True)
        x = unsqueeze(x)
        return x
